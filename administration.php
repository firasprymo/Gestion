                  ...
                  <!--   <li class="chat-panel dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="login.php"><i class="icon-signout"></i> Déconnexion </a>
                            </li>
                        </ul>
        ...
        <div id="left" >
            <div class="media user-media well-small">
                ...
                <div class="media-body">
                    <h5 class="media-heading" > Espace admin</h5>
           ...
           <ul id="menu" class="collapse">
             ...
             <li class="panel active">
                <a href="index.html" ><i class="icon-home"></i> Accueil</a></li>
                <li><a href="emploi.html"><i class="icon-table"></i> Listes des emplois </a></li>
                <li><a href="matiere.php"><i class="icon-book"></i> Listes des matiéres </a></li>

                <li><a href="login.php"><i class="icon-signin"></i> Page de connexion </a></li>
...
// lancement de la requête (on impose aucune condition puisque l'on désire obtenir la liste complète des propriétaires
                            $sql = "SELECT `id_util`, `nom_util`, `post_util`, `email_util`, `mdp_util` FROM utilisateur ORDER BY `id_util` ASC";

// on lance la requête (mysqli_query) et on impose un message d'erreur si la requête ne se passe pas bien (or die)
                            $req = mysqli_query($mysqli,$sql) or die();

// on va scanner tous les tuples un par un
                            while ($data = mysqli_fetch_array($req)) {?>
                            <td><?php echo $data['id_util']; ?></td>
                            <td name="nom"><?php echo $data['nom_util']; ?></td>
                            <td name="enseignant"><?php echo $data['post_util']; ?></td>
                            <td name="class"><?php echo $data['email_util'];?></td>
                            <td name="groupe"><?php echo $data['mdp_util'];?></td>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <div id="ajoututil">
                <form class="form-horizontal" id="ajoutmat" action="ajoututil.php" method="POST">
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="text" name="nom_util" placeholder="Nom de l'utilisateur' :" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-lg-push-4">
                            <select name="post_util" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-lg-push-4">
                                <input type="email"  name="email_util" placeholder="Adresse email :" class="form-control" />
                            </div>
                        </div>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-lg-push-4">
                                            <select name="groupe" class="form-control">
                                                <option >Choisir votre groupe</option>
                                   ...
                                   <!--  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-lg-push-4">
                                            <input type="password" id="text2" placeholder="Mot de passe" name="mdp_util" class="form-control" />
                                        </div>
                                    </div>
                                  <!--   <div class="form-group">
                                         <label for="text2" class="control-label col-lg-4">With Placeholder</label> 
                                        ...
                                        <div class="col-lg-8 col-lg-push-4">
                                            <input type="text" id="text3" placeholder="Nombre des séances" name="nombredeseance" class="form-control" />
                                        </div>
                                    </div> -->
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-lg-push-4">
                                            <select name="coef" class="form-control">
                                                <option >Choisir la coefficient</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div >
                                            <input type="submit" name="valider" id="btnvalider" class=" button col-lg-2 col-lg-push-10 button-block" name="login"  />
                                        </div>
                                    </div>
