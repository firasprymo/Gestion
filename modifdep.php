...
$sql = "SELECT * FROM departement WHERE id_dep='$id_dep'";
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <div id="ajoututil">
                <form name="insertion" class="form-horizontal" id="ajoutmat" action="modifdep2.php" method="POST">
<input type="hidden" name="id_dep" value="<?php echo ($id_dep);?>">
                    <div class="form-group">
                      <label for="text2" class="control-label  col-lg-4">Numéro département</label>

                        <div class="col-lg-8">

                        <input type="text" name="nom_dep" placeholder="Nom département :" class="form-control"  value="<?php echo($result['nom_dep']) ;?>" />
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="text2" class="control-label  col-lg-4">Chef département</label>

                        <div class="col-lg-8">

                        <input type="text" name="chef_departement" placeholder="Chef département :" class="form-control"  value="<?php echo($result['chef_departement']) ;?>" />
                        </div>
                    </div>
                     <div class="form-group">
                      <label for="text2" class="control-label  col-lg-4">Class</label>
                        ...
                        <input type="text" name="nom_class" placeholder="Class :" class="form-control"  value="<?php echo($result['nom_class']) ;?>" />
                        </div>
                    </div>
                     <div class="form-group">
                      <label for="text2" class="control-label  col-lg-4">Enseignant</label>
                        ...
                        <input type="text" name="nom_enseignant" placeholder="Enseignant :" class="form-control"  value="<?php echo($result['nom_enseignant']) ;?>" />
                        </div>
                    </div>
