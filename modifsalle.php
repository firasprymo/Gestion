        ...
        <div id="left" >
           ...
           <ul id="menu" class="collapse">
             ...
             <li class="panel active">
                <a href="index.html" ><i class="icon-user"></i> Utilisateurs</a></li>
                <li><a href="emploi.html"><i class="icon-table"></i> Listes des emplois </a></li>
                <li><a href="cour.php"><i class="icon-book"></i> Cours </a></li>

                <li><a href="index.php"><i class="icon-signin"></i> Page de connexion </a></li>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <div id="ajoututil">
                <form name="insertion" class="form-horizontal" id="ajoutmat" action="modifsalle2.php" method="POST">
<input type="hidden" name="id_salle" value="<?php echo ($id_salle);?>">
                    <div class="form-group">
                      <label for="text2" class="control-label  col-lg-4">Numéro salle</label>

                        <div class="col-lg-8">

                        <input type="text" name="nom_salle" placeholder="nom_salle :" class="form-control"  value="<?php echo($result['nom_salle']) ;?>" />
                        </div>
                    </div>
