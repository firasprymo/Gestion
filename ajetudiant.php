...
<div class="row">
    <div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <div id="ajoututil">
                <form class="form-horizontal" id="ajoutmat" action="ajetudiant1.php" method="POST">
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="text" name="nom_etudiant" placeholder="Nom de l'etudiant :" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
...
?> </select> </div></div>
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="email" name="email_etudiant" placeholder="Adresse email :" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="number" name="CIN_etudiant" placeholder="CIN :" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="number" name="carte_etudiant" placeholder="Carte etudiant :" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-lg-push-4">
                            <input type="password" name="mdp_etudiant" placeholder="Mot de passe :" class="form-control" />
                        </div>
                    </div>
